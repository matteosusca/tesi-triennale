...
Nel 1984 viene presentato dal Massachusetts Institute of Technology il X Window System, successore del W Window System. Il sistema X si basa su una archittettura client-server dove il server è il computer che ospita l'interfaccia grafica e il client è il computer che si connette al server per visualizzare l'interfaccia grafica.
