...
\title{Tecnologie di Desktop Remoto: Evoluzione, Applicazioni Moderne e Prospettive Future}
\author{Matteo Susca}
\date{\today}
...
\begin{acknowledgements} % this is optional
    Desidero esprimere la mia più profonda gratitudine a tutte le persone che mi hanno accompagnato e supportato durante il percorso di studi e nella stesura di questa tesi. Innanzitutto, ringrazio il mio relatore, Prof. Franco Callegati, per la sua guida e la disponibilità che hanno reso possibile la realizzazione di questo lavoro.

    Ringrazio la mia famiglia, che mi ha sempre sostenuto e incoraggiato, dimostrandomi fiducia e amore in ogni momento di questo percorso. Grazie per aver creduto nelle mie capacità anche quando io stesso ho avuto dei dubbi.

    Ringrazio i miei amici e colleghi Mattia, Riccardo, Filippo, Silvia, Andrea, Tommaso, Alessia, Anna, Eleonora, Anny, e Samu con cui ho condiviso la maggior parte delle mie giornate universitarie.
    
    Un ringraziamento speciale va a Angelo, che mi ha fornito un indispensabile supporto tecnico e sopratutto morale durante la stesura di questa tesi, sopportando tutti i miei dubbi e le mie incertezze.

    Ringrazio la mia amica e collega a distanza, Elisa, per le sessioni di studio che dalla maturità ci hanno portato fino alla laurea.

    Un ringraziamento speciale va a Emanuele, amico e compagno di studi ormai da nove anni, che ancora mi sopporta nonostante tutto.
    ...
    Ringrazio anche i miei ormai storici amici del G.D.S., che ormai da anni si sono dimostrati una costante nella mia vita, sempre in grado di ricordarmi di non prendermi troppo sul serio.

    Ringrazio Giulio e Desy, non due amici, ma da sempre come fratelli, per essere una costante nella mia vita ed una spalla su cui poter contare dal giorno uno.

    Un ringraziamento particolare va alla mia ragazza Anna, per la pazienza, il supporto e l’incoraggiamento che mi ha dimostrato in ogni fase di questo percorso.
