...
\begin{abstract}
    Negli ultimi decenni, le tecnologie di desktop remoto hanno acquisito crescente rilevanza, trovando applicazione in ambiti diversi, dal telelavoro al cloud gaming. Questa tesi si propone di analizzare l’evoluzione e lo stato attuale delle principali tecnologie di desktop remoto, illustrandone i protocolli, le caratteristiche e le innovazioni. L’analisi parte dalle prime tecnologie di accesso remoto, come l'X Window System e il protocollo VNC, per arrivare a strumenti moderni e ottimizzati per basse latenze come Parsec.
    
    Sono stati inoltre esaminati gli utilizzi attuali delle tecnologie di desktop remoto in contesti lavorativi e di intrattenimento. Il telelavoro e l'assistenza remota dimostrano come queste soluzioni abbiano migliorato la produttività e ridotto i costi operativi. Il cloud gaming, come esempio di applicazione avanzata, evidenzia le sfide e le soluzioni tecniche necessarie per garantire un'esperienza fluida e di alta qualità per l’utente finale.
    
    Infine, sono esplorate le prospettive future delle tecnologie di desktop remoto, incluse soluzioni avanzate come Desktop as a Service (DaaS) ed edge computing, che offrono scenari sempre più dinamici e scalabili. La tesi conclude proponendo riflessioni sull'evoluzione delle tecnologie di desktop remoto, con uno sguardo alle possibili sfide future, come la sicurezza, la gestione della latenza e l’integrazione con reti ad alta velocità.
\end{abstract}
...
Con l'avanzare della tecnologia, questi problemi potrebbero essere risolti, tramite l'utilizzo di headset più leggeri ed ergonomici, con l'aumento del framerate, della risoluzione e altre migliorie. Bisogna inoltre sottolineare come l'esperienza utente sia estremamente soggettiva, e individui meno sensibili potrebbero non riscontrare questi problemi già ad oggi. %TODO
